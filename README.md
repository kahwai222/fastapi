...
[![codecov](https://codecov.io/gh/kahwai222/fastapi/branch/main/graph/badge.svg?token=fastapi_token_here)](https://codecov.io/gh/kahwai222/fastapi)
[![CI](https://github.com/kahwai222/fastapi/actions/workflows/main.yml/badge.svg)](https://github.com/kahwai222/fastapi/actions/workflows/main.yml)

Awesome fastapi created by kahwai222

## Install

from source
```bash
git clone https://github.com/kahwai222/fastapi fastapi
cd fastapi
make install
```
